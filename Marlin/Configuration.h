...
#define STRING_CONFIG_H_AUTHOR "(Miko, SV05 1.0)" // Who made the changes.
...
#define LCD_BED_LEVELING
  ...
  #define MESH_EDIT_Z_STEP  00.01 // (mm) Step size while manually probing Z axis.
